...
Preprocessing:
  - Gold already provides median-imputed billed amount features.
  - The sklearn median imputer remains as a safety net for any residual numeric
    nulls, such as missing cost benchmarks.
  - Imputation is fitted on train set only to avoid leakage.
"""
    ...
    def run(self) -> dict:
        ...
        try:
            ...
            training_report = {
                ...
                "recommended_model":   (
                    "xgboost" if xgb_metrics["roc_auc"] >= lr_metrics["roc_auc"]
